;; xzhao emacs config file
(setq user-full-name "xzhao")
(setq user-mail-address "81316707@qq.com")
...
(setenv "GOPATH" (concat (getenv "HOME") "/work/gowork"))
(setenv "GOBIN" (concat (getenv "HOME") "/work/gowork/bin"))
(setenv "PATH" (concat ""
                       (getenv "PATH")
                       ":"
                       (getenv "GOROOT")
